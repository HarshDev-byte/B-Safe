...
dependencies {
    ...
    // Compose - Using explicit compatible versions (no BOM)
    // Kotlin 1.9.22 requires Compose Compiler 1.5.8, which works with Compose 1.6.x
    ...
    val composeVersionTest = "1.6.1"
    androidTestImplementation("androidx.compose.ui:ui-test-junit4:$composeVersionTest")
    debugImplementation("androidx.compose.ui:ui-tooling:$composeVersionTest")
    debugImplementation("androidx.compose.ui:ui-test-manifest:$composeVersionTest")
}
